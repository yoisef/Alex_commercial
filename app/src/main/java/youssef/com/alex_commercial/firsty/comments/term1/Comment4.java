package youssef.com.alex_commercial.firsty.comments.term1;
...
public class Comment4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refcomments = firebaseDatabase.getReference("Comments").child("year1").child("term1").child("com4");
