package youssef.com.alex_commercial.firsty.comments.term2;
...
public class Comment3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refcomments = firebaseDatabase.getReference("Comments").child("year1").child("term2").child("com3");
