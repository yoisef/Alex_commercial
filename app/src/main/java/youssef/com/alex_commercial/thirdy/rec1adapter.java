...
import youssef.com.alex_commercial.firsty.comments.term1.Comment1;
import youssef.com.alex_commercial.firsty.comments.term1.Comment2;
import youssef.com.alex_commercial.firsty.comments.term1.Comment3;
import youssef.com.alex_commercial.firsty.comments.term1.Comment4;
import youssef.com.alex_commercial.firsty.comments.term1.Comment5;
import youssef.com.alex_commercial.firsty.comments.term1.Comment6;
            ...
            public void onClick(View view) {
                switch (z) {
                    case 0: {
                        ...
                        Intent i = new Intent(contextt, Comment1.class);
                        contextt.startActivity(i);
                             break;
                    }
                    case 1:{
                        Intent i = new Intent(contextt, Comment2.class);
                        contextt.startActivity(i);
                        break;
                    }

                    case 2: {
                        Intent i = new Intent(contextt, Comment3.class);
                        contextt.startActivity(i);
                        break;
                    }
                    case 3:{
                        Intent i = new Intent(contextt, Comment4.class);
                        contextt.startActivity(i);
                        break;

                    }
                    case 4:{
                        Intent i = new Intent(contextt, Comment5.class);
                        contextt.startActivity(i);
                        break;
                    }
                    case 5:{
                        Intent i = new Intent(contextt, Comment6.class);
                        contextt.startActivity(i);
                        break;
                    }
